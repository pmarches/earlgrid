...
public class SortCmdSpecificationTest {
  ...
  public void testPerformComputation() throws Exception {
    ...
    ExecutionHistoryRecord sortedUsernames = testClient.execute("history 0 | sort -f Username ");
    ...
    ExecutionHistoryRecord reverseSortedUsernames = testClient.execute("history 0 | sort -r -f Username ");
